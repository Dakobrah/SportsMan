...
export function makeSnap(overrides: Partial<Snap> = {}): Snap {
  return {
    ...
    ballCarrierId: null,
    quarterbackId: null, targetId: null, receiverId: null, isComplete: false,
    ...
    kickerId: null, holderId: null, result: null, isTouchback: false, outOfBounds: false,
    punterId: null, puntYards: 0, hangTimeSeconds: null, isBlocked: false,
