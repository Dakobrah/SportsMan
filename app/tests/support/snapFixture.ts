...
export function makeSnap(overrides: Partial<Snap> = {}): Snap {
  return {
    ...
    quarterbackId: null, quarterbackNumber: null, targetId: null, targetNumber: null,
    ...
    returnerId: null, returnerNumber: null, returnYards: 0, isFairCatch: false, hangTimeSeconds: null, isBlocked: false,
