...
urlpatterns = [
    ...
    path('games/<int:pk>/tracker/update-quarter/', tracker.tracker_update_quarter, name='update_quarter'),
    ...
    path('games/<int:pk>/tracker/state/', tracker.tracker_state, name='state'),
]
